...
class PwsMeter extends PolymerElement {
    static get template() {
      return html`   
      <style>
          .score1 { background-color:gray; width:10%; height:100%; transition: width 300ms ease-out; }
          .score2 { background-color:red;  width:25%; height:100%; transition: width 300ms ease-out; }
          .score3 { background-color:yellow; width:50%; height:100%; transition: width 300ms ease-out;  }
          .score4 { background-color:blue; width:75%; height:100%; transition: width 300ms ease-out; }
          .score5 { background-color:green; width:95%; height:100%; transition: width 300ms ease-out; }
